...
Bu eklenti, verdiğiniz ürün sayfasını düzenli aralıklarla kontrol eder. Sayfada stokta olduğunu gösteren ifadeler bulunursa Pushover üzerinden bildirim gönderir.

## Ayarlar

- `product_url`: Kontrol edilecek ürün linki.
...
- `notify_once`: Ürün stoktayken yalnızca bir kere bildirim gönderir. Ürün tekrar stok dışı görünüp sonra stoğa girerse yeniden bildirir.
...
6. Eklenti ayarlarına ürün linkinizi ve Pushover bilgilerinizi girin.
